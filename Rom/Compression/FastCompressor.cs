...
namespace EpicEdit.Rom.Compression
{
    ...
    internal class FastCompressor : ICompressor
    {
        ...
        private static void CallCommand4Or6(byte[] compBuffer, ref int i, ref int j, EpicEdit.Rom.Utility.Range range)
        {
        ...
        private static EpicEdit.Rom.Utility.Range GetRange(int start, int end)
        {
            var range = new EpicEdit.Rom.Utility.Range(start, end);
